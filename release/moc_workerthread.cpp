...
QT_MOC_LITERAL(13, 12), // "finishedLine"
QT_MOC_LITERAL(26, 0), // ""
QT_MOC_LITERAL(27, 27), // "QList<WorkerThread::Pixel>*"
QT_MOC_LITERAL(55, 1) // "p"

    },
    "WorkerThread\0finishedLine\0\0"
    "QList<WorkerThread::Pixel>*\0p"
};
...
void WorkerThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->finishedLine((*reinterpret_cast< QList<WorkerThread::Pixel>*(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (WorkerThread::*)(QList<WorkerThread::Pixel> * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WorkerThread::finishedLine)) {
                *result = 0;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<WorkerThread, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<QList<WorkerThread::Pixel> *, std::false_type>
...
// SIGNAL 0
void WorkerThread::finishedLine(QList<WorkerThread::Pixel> * _t1)
{
